...
class RFIDBasedRecordingNode(Node):
    def __init__(self, topic_names, message_types, max_duration_s, base_bag_dir="/workspaces/isaac_ros-dev/bags/pen1/3D", log_dir="/workspaces/isaac_ros-dev/recording_logs/pen1/3D"):
        ...
        # Parameters
        self.db_path = "/home/dcs/workspaces/isaac_ros-dev/sql_database/feeder_interaction.db"
        ...
        self.standing_pig_at_feeder = None # Check the pig at feeder is standing
        ...
        # Timer to check for RFID timeout, standing pig and periodic recording
    ...
    def check_standing_pig(self):
        """Check the standing pig at feeder"""
