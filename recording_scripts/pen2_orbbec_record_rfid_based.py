...
class RFIDBasedRecordingNode(Node):
    def __init__(self, topic_names, message_types, max_duration_s, base_bag_dir="/workspaces/isaac_ros-dev/bags/pen2/3D", log_dir="/workspaces/isaac_ros-dev/recording_logs/pen2/3D"):
        ...
        self.create_subscription(String, '/pen2_rfid', self.rfid_callback, 10)
...
def main(args=None):
    ...
    default_topics = [
        ...
        '/pen2_camera_1/color/camera_info', '/pen2_camera_1/depth/camera_info',
        '/pen2_camera_2/color/camera_info', '/pen2_camera_2/depth/camera_info',
        '/pen2_rfid'
    ]
