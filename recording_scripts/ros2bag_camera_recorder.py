...
class Ros2BagRecorder:
    def __init__(self, topic_names, bag_filename=None):
        ...
        log_filename = os.path.join(self.log_folder, f"ros2bag_record_log_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
        logging.basicConfig(
            level=logging.INFO,
...
if __name__ == "__main__":
    ...
    while True:
        ...
        recorder.bag_filename = os.path.join(args.output, f"bag_{timestamp}")
